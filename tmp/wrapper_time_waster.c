...
// Target library path
static const char *target_library = "/home/guillaume2/Documents/Informatique/WORKSPACE_ECLIPSE/SpecProf/tmp/TimeWaster/libTimeWaster.so";
// Target symbol
static const char *target_symbol = "waste_time";
// Specific pointer to function type
typedef void (*func_ptr)(int seconds);
